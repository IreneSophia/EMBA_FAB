...
# S1.3 Explorative analysis of subject-specific FAB with RADS and ASRS
...
Furthermore, Bayesian Spearman correlations revealed `r interpret_bf(asrs.bf)` against associations between FAB and questionnaires assessing ASD (RADS: log(*BF*) = `r round(log(rads.bf),2)`) or ADHD (ASRS: log(*BF*) = `r round(log(asrs.bf),2)`). 
...
# S1.4 Explorative analysis of RTs considering number of saccades
