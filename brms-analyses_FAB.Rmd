...
# FAB effect in ADHD
e5 = hypothesis(m.err, "0 < -2*cue1 - 2*diagnosis1:cue1", alpha = 0.025)
e5

# FAB effect in ASD
e6 = hypothesis(m.err, "0 < -2*cue1 - 2*diagnosis2:cue1", alpha = 0.025)
e6

# FAB effect in ADHD+ASD
e7 = hypothesis(m.err, "0 < -2*cue1 - 2*diagnosis3:cue1", alpha = 0.025)
e7
