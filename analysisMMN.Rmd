...
# debugging: df.log = df.log1 %>% filter(Subject == "KP8UE7DAZ7")
...
``` {r heat_subject, echo = T, message = F, fig.width = 8, fig.height = 16, fig.align = "center", warning = F}
...
``` {r heat, echo = T, message = F, fig.width = 12, fig.height = 8, fig.align = "center", warning = F}
